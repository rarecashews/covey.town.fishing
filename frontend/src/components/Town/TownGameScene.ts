...
import FishingArea from './interactables/FishingArea';
import FishingDisplayArea from './interactables/FishDisplayArea';

// Still not sure what the right type is here... "Interactable" doesn't do it
// eslint-disable-next-line @typescript-eslint/no-explicit-any
function interactableTypeForObjectType(type: string): any {
  switch (type) {
    case 'ConversationArea':
    ...
    case 'FishingArea':
      return FishingArea;
    case 'FishDisplayArea':
      return FishingDisplayArea;
    default:
