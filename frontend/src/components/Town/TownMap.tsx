...
import FishingAreaWrapper from './interactables/FishingAreaWrapper';
import TradingAreaWrapper from './interactables/TradingArea/TradingAreaWrapper';
import FishDisplayAreaWrapper from './interactables/FishDisplayArea/FishingDisplayAreaWrapper';
